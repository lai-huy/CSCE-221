...
bool test_insert_right() {
    ...
    rbt.insert(14);
    {
        ...
        assert(root->left->color == RedBlackTree<int>::Color::BLACK);
        assert(root->left->left != nullptr);
...
bool test_copy() {
    ...
    RedBlackTree<int> a(rbt);
    {
        ...
        assert(root->left != nullptr);
        assert(root->left != rooot->left);
        assert(root->left->value == 4);
        assert(root->left->value == rooot->left->value)
            assert(root->left->left != nullptr);
        assert(root->left->left != rooot->left->left);
        assert(root->left->left->value == 2);
        assert(root->left->left->value == rooot->left->left->value);
        assert(root->left->left->left == nullptr);
        assert(root->left->left->right == nullptr);
        assert(root->left->right != nullptr);
        assert(root->left->right->value == 6);
