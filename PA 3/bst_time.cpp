...
bool test_create() {
    std::chrono::time_point start = high_resolution_clock::now();
    BinarySearchTree<int> bst;
    std::chrono::time_point end = high_resolution_clock::now();
    assert(bst.root() == nullptr);
    auto durr = std::chrono::duration_cast<nanoseconds>(end - start);
    cout << "Time:\t" << durr.count() << "\n";
